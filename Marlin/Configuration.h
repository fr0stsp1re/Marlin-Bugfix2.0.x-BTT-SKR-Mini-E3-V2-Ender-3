...
#define STRING_CONFIG_H_AUTHOR "(Adrian Raff, Ender-3 Pro, BTT SKR Mini E3 V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BiG Tree Tech Ender 3 Pro"
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN PA8
  #define RGB_LED_G_PIN PA8
  #define RGB_LED_B_PIN PA8
