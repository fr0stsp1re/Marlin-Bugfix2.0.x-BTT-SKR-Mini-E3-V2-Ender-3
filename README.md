...
Enables NeoPixel LEDs W start up test and temprature reactive LED colors.
Removes software endstops/Enables menu item.
Enables baby stepping on Z axis
Allows movement to negative values on Z axis upon disabling software endstops in menu.
